...
import { FileText, Edit, Trash2, PlusCircle, User, Database } from "lucide-react";
...
export default function ActivityTimeline({ logs, maxItems = 50 }: ActivityTimelineProps) {
                                ...
                                <div className="flex items-start justify-between gap-4">
                                    <div className="flex-1 space-y-1">
                                        ...
                                        <div className="flex items-center gap-4 text-xs text-muted-foreground">
                                            ...
                                            {log.recordId && (
                                                <span className="font-mono">ID: {log.recordId.slice(0, 8)}...</span>
                                            )}
                                        </div>
                                    </div>
