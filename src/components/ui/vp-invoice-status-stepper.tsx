// src/components/vendor-portal/ui/vp-invoice-status-stepper.tsx
...
const STEPS = [
    ...
    { key: "PAYMENT_INITIATED", label: "Payment Sent" },
...
export function VpInvoiceStatusStepper({ status }: { status: string }) {
